...
const breakingNews = [
  "Breaking: Real Madrid Defeats Barcelona 2-1 in El Clásico",
  "Remembering Stella Obasanjo 20 years after",
  "Vinicius Junior Furious: Real Madrid star blanks Xabi Alonso & storms down tunnel after being subbed early vs Barcelona",
  ,
];
